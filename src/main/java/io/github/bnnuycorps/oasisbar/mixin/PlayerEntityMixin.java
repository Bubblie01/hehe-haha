...
public abstract class PlayerEntityMixin extends LivingEntity implements ThirstManagerInt, PlayerInt {
    ...
    private void eatFoodMixin(World world, ItemStack stack, CallbackInfoReturnable<ItemStack> info) {
        ...
        if (thirstQuench > 0)
            ((ThirstManagerInt) (PlayerEntity) (Object) this).getThirstManager().add(thirstQuench);
    }
